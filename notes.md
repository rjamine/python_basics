...
2. Debian apperentley uses python3 as a 'metapackage' to install the latest stable python interpreter and/or any other version you want/need, and other GNU/Linux distros may do it differently, and other OS's defintley do it differently, I think its kind of clever.
3. 
--- 
